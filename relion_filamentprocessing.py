...
parser.add_argument('--make_fibretwist_movie', nargs = 2, metavar = '[frame rate] [length of video (seconds)]', help = 'Make a movie showing a twisting fibre')
...
if args.make_fibretwist_movie:
    ...
    superparticles.makeTurningFilamentVideo(args.input, int(args.make_fibretwist_movie[0]), int(args.make_fibretwist_movie[1]))
